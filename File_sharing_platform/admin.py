...
class FileAdmin(admin.ModelAdmin):
    list_display = ['title', 'category', 'author', 'thumbnail_preview', 'file_status', 'file_views', 'created_at']
    list_filter = ['file_status', 'category', 'created_at']
    search_fields = ['title', 'file_description']
    readonly_fields = ['file_views', 'created_at', 'updated_at', 'thumbnail_preview']
